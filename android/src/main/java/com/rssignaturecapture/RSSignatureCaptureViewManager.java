...
public class RSSignatureCaptureViewManager extends ViewGroupManager<RSSignatureCaptureMainView> {
	...
	public static final String PROPS_MAX_SIZE="maxSize";
 	public static final String PROPS_FIXED_STROKE_WIDTH="fixedStrokeWidth";
	...
	@ReactProp(name = PROPS_FIXED_STROKE_WIDTH)
 	public void setPropsFixedStrokeWidth(RSSignatureCaptureMainView view, @Nullable int fixedStrokeWidth) {
 		Log.d("fixedStrokeWidth:",  ""+fixedStrokeWidth);
 		if(view!=null){
 			view.getSignatureView().setFixedStrokeWidth(fixedStrokeWidth);
 		}
 	}
